...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) {
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is in Beta and it is newer than the current Bambu Hui version."));
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try Bambu Hui Beta, you may click to"));
        ...
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is newer than the current Bambu Hui version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Update your Bambu Hui could enable all functionality in the 3mf file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
    ...
    if (!file_version_newer) {
        ...
        m_update_btn->Bind(wxEVT_LEFT_DOWN, [this](wxMouseEvent &e) {
            ...
            if (wxGetApp().app_config->has("app", "cloud_software_url")) {
                ...
                BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << "Bambu Hui conf has no cloud_software_url and file_version: " << m_file_version->to_string()
